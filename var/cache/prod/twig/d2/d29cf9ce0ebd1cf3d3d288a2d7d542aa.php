...
class __TwigTemplate_61a32752fefd6b6bd58ada5a4d8395fa extends Template
{
    private $source;
    private $macros = [];
...
($context["grid"] ?? null), "view_options", [], "any", false, true, false, 41), "pagination_view", [], "any", true, true, false, 41)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "view_options", [], "any", false, true, false, 41), "pagination_view", [], "any", false, false, false, 41), "full")) : ("full"))]));
  ...
  ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Blocks/pagination.html.twig", "/home/u781792684/domains/pierre-paquin.fr/public_html/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/Blocks/pagination.html.twig");
    }
}
