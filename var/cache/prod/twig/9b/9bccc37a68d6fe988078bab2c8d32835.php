...
class __TwigTemplate_e2928261d34f973235e04fcd30b51eb4 extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("origin", $context)) ? (_twig_default_filter(($context["origin"] ?? null), "none")) : ("none"))]));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/grid_notification_configure.html.twig", "/home/u781792684/domains/pierre-paquin.fr/public_html/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/grid_notification_configure.html.twig");
    }
}
