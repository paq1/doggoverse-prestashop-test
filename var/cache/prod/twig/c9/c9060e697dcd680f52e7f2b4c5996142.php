...
class __TwigTemplate_a0a479551553cd8f8e3f3db05c5b9fa9 extends Template
{
    private $source;
    private $macros = [];
...
<button id=\"";
        ...
        // line 27
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "options", [], "any", false, false, false, 27), "customers_bulk_delete_route", [], "any", false, false, false, 27));
        echo "\"
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Actions/Bulk/delete_customers.html.twig", "/home/u781792684/domains/pierre-paquin.fr/public_html/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/Actions/Bulk/delete_customers.html.twig");
    }
}
